class SalleCinema {
    ...
    private nbPlace: number;
    private prix: number;
    private nbPlaceTarifNormal: number;
    private nbPlaceTarifReduit: number;
    ...
    vendrePlaces(nbre: number, tarifReduit: boolean): number {
        let prix: number;
...
function reservation() {
    let inputPlace = document.querySelector("#nbPlace") as HTMLInputElement;
    let checkbox = document.querySelector("#promo") as HTMLInputElement;
    let select = document.querySelector("#film") as HTMLSelectElement;
